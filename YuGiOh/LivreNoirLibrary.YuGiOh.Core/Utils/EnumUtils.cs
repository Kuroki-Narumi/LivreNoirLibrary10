...
namespace LivreNoirLibrary.YuGiOh
{
    ...
    {
        public static CardType[] CardTypes { get; } = [.. EnumerateCardTypes(true, true, true)];
        public static MonsterType[] MonsterTypes { get; } = [.. EnumerateMonsterTypes(true)];
        public static Attribute[] Attributes { get; } = [.. EnumerateAttributes(true)];
        ...
        public static int GetCount(this LinkDirection dir) => int.PopCount((int)dir);

        public static bool IsValid(this LinkDirection dir) => (uint)dir <= 255u;

        public static IEnumerable<CardType> EnumerateCardTypes(bool monster = true, bool spell = true, bool trap = true)
        {
            if (monster)
            {
        ...
        public static IEnumerable<MonsterType> EnumerateMonsterTypes(bool includesSpecial = true)
        {
        ...
        public static IEnumerable<Attribute> EnumerateAttributes(bool includesSpecial = true)
        {
        ...
        public static IEnumerable<Ability> EnumerateAbilities(bool includeEffect = false)
        {
            if (includeEffect)
            {
                yield return Ability.Normal;
        ...
        public static IEnumerable<LinkDirection> EnumerateAllLinkDirection()
        {
