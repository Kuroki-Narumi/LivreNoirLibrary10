...
namespace LivreNoirLibrary.YuGiOh
{
    public static partial class TextConvert
    {
        ...
        [GeneratedRegex("[！＄（）＊＋，．＜＝＞？＼＾｛｜｝]")]
        private static partial Regex Regex_Wide_Regex { get; }
