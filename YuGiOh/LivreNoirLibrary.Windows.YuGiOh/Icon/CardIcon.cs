...
namespace LivreNoirLibrary.Windows.YuGiOh
{
    public static partial class Icons
    {
        ...
        {
            { CardIconType.Field_Spell, 
                MediaUtils.CreateGeometry("M6,2 v10 l2,-3 l-4,-4 Z M1,7 h10 l-3,-2 l-4,4 Z") },
            { CardIconType.Equip_Spell, 
                MediaUtils.CreateGeometry("M2,6 h3 v-3 h2 v3 h3 v2 h-3 v3 h-2 v-3 h-3") },
            { CardIconType.Continuous_Spell, 
                MediaUtils.CreateGeometry("M1,7 a3,3,0,0,0,5,2.236 a3,3,0,0,0,5,-2.236 a3,3,0,0,0,-5,-2.236 a3,3,0,0,0,-5,2.236 Z M2.5,7 a1.5,1.5,0,0,0,3,0 a1.5,1.5,0,0,0,-3,0 Z M6.5,7 a1.5,1.5,0,0,0,3,0 a1.5,1.5,0,0,0,-3,0 Z") },
            { CardIconType.Quick_Spell, 
                MediaUtils.CreateGeometry("M6,3 l-3,3 l3,2 l-3,3 h3 l3,-3 l-3,-2 l3,-3 Z") },
            { CardIconType.Ritual_Spell, 
                MediaUtils.CreateGeometry("M6,3 l-2,4 l-2,-2 l1,4 l3,2 l3,-2 l1,-4 l-2,2 Z") },
            { CardIconType.Continuous_Trap, 
                MediaUtils.CreateGeometry("M1,7 a3,3,0,0,0,5,2.236 a3,3,0,0,0,5,-2.236 a3,3,0,0,0,-5,-2.236 a3,3,0,0,0,-5,2.236 Z M2.5,7 a1.5,1.5,0,0,0,3,0 a1.5,1.5,0,0,0,-3,0 Z M6.5,7 a1.5,1.5,0,0,0,3,0 a1.5,1.5,0,0,0,-3,0 Z") },
            { CardIconType.Counter_Trap, 
