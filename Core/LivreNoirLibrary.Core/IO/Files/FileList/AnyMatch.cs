...
namespace LivreNoirLibrary.IO
{
    public static partial class FileList
    {
        ...
        public static bool AnyMatch(this List<string> paths, Regex acceptExt) => AnyMatchCore(paths.AsSpan(), acceptExt);
        ...
        public static bool AnyMatch(this List<string> paths, params ReadOnlySpan<Regex> acceptExts) => AnyMatchCore(paths.AsSpan(), acceptExts);
