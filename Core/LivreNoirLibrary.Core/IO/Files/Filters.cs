...
namespace LivreNoirLibrary.IO
{
    public static partial class Filters
    {
        ...
        public static readonly string Bmg_Save = Create(nameof(Bmg_Save), "Generic BMS", Exts.Bmg);
        ...
        public static readonly string BeMusic_Save = Join(Bms_Save, Pms_Save, Bmg_Save, B_Save, Bmson);
        public static readonly string BeMusic_Save_P = Join(Pms_Save, Bms_Save, Bmg_Save, B_Save, Bmson);
        public static readonly string BeMusic_Save_G = Join(Bmg_Save, Bmson, Bms_Save, Pms_Save, B_Save);
