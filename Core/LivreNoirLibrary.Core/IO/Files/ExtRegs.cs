...
namespace LivreNoirLibrary.IO
{
    ...
    {
        [GeneratedRegex(@"\.\w+$")]
        public static partial Regex Regex_Extension { get; }
        ...
        public static readonly Regex Aiff = Create(Exts.Aif, Exts.Aiff);
        ...
        public static readonly Regex Bmg = Create(Exts.Bmg);
