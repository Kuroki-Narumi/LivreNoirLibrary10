...
namespace LivreNoirLibrary.IO
{
    public static class General
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Open<T>(string path) where T : IStreamLoadable<T> => OpenInternal(path, T.Load);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Save<T>(string path, T data, Regex? extReg = null, string ext = "") where T : IStreamDumpable => SaveInternal(path, data.Dump, extReg, ext);
