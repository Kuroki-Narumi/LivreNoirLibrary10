...
namespace LivreNoirLibrary.Collections
{
    public interface IComparer<T1, T2>
    {
        ...
        abstract static int Compare(T1 x, T2 y);
        ...
        /// <returns>
        /// <see langword="true"/> if <paramref name="x"/> is closer to <paramref name="z"/> than <paramref name="y"/>; otherwise <see langword="false"/>.
        /// </returns>
        abstract static bool IsXCloserThanY(T1 x, T1 y, T2 z);
    }
}
