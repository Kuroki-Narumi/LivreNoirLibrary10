...
namespace LivreNoirLibrary.Media.Wave.Chunks
{
    public sealed class LIST(string type) : RiffChunk, IRiffChunk<LIST>, ICollection<DataChunk>
    {
        ...
        public string? GetText(string tag, System.Text.Encoding? encoding = null) => Find(tag)?.GetText(encoding);
        public string? GetText(string tag, int id, System.Text.Encoding? encoding = null) => Find(tag, id)?.GetText(encoding);

        public bool TryGetText(string tag, [MaybeNullWhen(false)]out string text, System.Text.Encoding? encoding = null)
        {
            text = GetText(tag, encoding);
            return !string.IsNullOrEmpty(text);
        }

        public bool TryGetText(string tag, int id, [MaybeNullWhen(false)]out string text, System.Text.Encoding? encoding = null)
        {
        ...
        public void SetText(string chid, string text, System.Text.Encoding? encoding = null) => Set(chid, (encoding ?? System.Text.Encoding.UTF8).GetBytes(text));
        public void SetText(string chid, int id, string text, System.Text.Encoding? encoding = null) => Set(chid, id, (encoding ?? System.Text.Encoding.UTF8).GetBytes(text));
        ...
        public void Add(string chid, string text, System.Text.Encoding? encoding = null) => SubChunks.Add(new Chunk(chid, (encoding ?? System.Text.Encoding.UTF8).GetBytes(text)));
        public void Add(string chid, int id, byte[] data) => SubChunks.Add(new IdChunk(chid, id, data));
        public void Add(string chid, int id, string text, System.Text.Encoding? encoding = null) => SubChunks.Add(new IdChunk(chid, id, (encoding ?? System.Text.Encoding.UTF8).GetBytes(text)));
