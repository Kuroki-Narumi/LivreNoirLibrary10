...
namespace LivreNoirLibrary.Media
{
    public partial class DoubleMultiTimeline<TValue> : XMultiTimelineBase<double, TValue, Operator_double>
    {
        ...
        public int RemoveAll(Predicate<double, TValue> predicate, Range<decimal> range) => RemoveAllCore(predicate, GetPositionIndex(_pos_list, range));
        public void MoveAll(Predicate<double, TValue> predicate, Func<double, double> converter, Range<decimal> range) => MoveAllCore(predicate, converter, GetPositionIndex(_pos_list, range));
