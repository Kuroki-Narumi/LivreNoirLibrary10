...
namespace LivreNoirLibrary.Media
{
    public partial class IntKeyTimeline<TKey, TValue> : XYSingleTimelineBase<TKey, int, TValue, Operator_int> where TKey : struct
    {
        ...
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<long> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<long> srcRange, int destOffset) 
        ...
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<double> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<double> srcRange, int destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
        ...
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<decimal> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, int, TValue> destination, Range<decimal> srcRange, int destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
