...
namespace LivreNoirLibrary.Media
{
    public partial class RationalKeyTimeline<TKey, TValue> : XYSingleTimelineBase<TKey, Rational, TValue, Operator_Rational> where TKey : struct
    {
        ...
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<int> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<int> srcRange, Rational destOffset) 
        ...
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<long> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<long> srcRange, Rational destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
        ...
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<float> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<float> srcRange, Rational destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
        ...
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<double> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<double> srcRange, Rational destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
        ...
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<decimal> srcRange) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), 0);
        public void CopyTo(IXYSingleTimeline<TKey, Rational, TValue> destination, Range<decimal> srcRange, Rational destOffset) 
            => CopyToCore(destination, _value_list.Keys, p => p.IndexRange(srcRange), destOffset);
