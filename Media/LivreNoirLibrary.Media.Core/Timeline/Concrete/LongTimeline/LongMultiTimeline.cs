...
namespace LivreNoirLibrary.Media
{
    public partial class LongMultiTimeline<TValue> : XMultiTimelineBase<long, TValue, Operator_long>
    {
        ...
        public int RemoveAll(Predicate<long, TValue> predicate, Range<double> range) => RemoveAllCore(predicate, GetPositionIndex(_pos_list, range));
        public void MoveAll(Predicate<long, TValue> predicate, Func<long, long> converter, Range<double> range) => MoveAllCore(predicate, converter, GetPositionIndex(_pos_list, range));
        ...
        public int RemoveAll(Predicate<long, TValue> predicate, Range<decimal> range) => RemoveAllCore(predicate, GetPositionIndex(_pos_list, range));
        public void MoveAll(Predicate<long, TValue> predicate, Func<long, long> converter, Range<decimal> range) => MoveAllCore(predicate, converter, GetPositionIndex(_pos_list, range));
