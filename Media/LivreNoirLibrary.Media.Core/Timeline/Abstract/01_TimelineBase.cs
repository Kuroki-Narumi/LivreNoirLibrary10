...
namespace LivreNoirLibrary.Media
{
    ...
    {
        protected static readonly TOperator _operator = new();
        ...
        public ReadOnlySpan<TX> GetPositions(Range<TX> range) => _pos_list.Range(range, _operator);
        ...
        protected static (int Start, int Length) GetPositionIndex(List<TX> list, Range<TX> range) => list.IndexRange(range, _operator);
        ...
        protected static int FindNextOrEqual(List<TX> list, TX position) => list.FindIndex(position, _operator, SearchMode.NextOrEqual);
        protected static int FindPreviousOrEqual(List<TX> list, TX position) => list.FindIndex(position, _operator, SearchMode.PreviousOrEqual);
