...
namespace LivreNoirLibrary.Media.Midi
{
    ...
    {
        public static bool BulkEdit<T>(this T track, BulkEditOptions options, ISelection? selection, [MaybeNullWhen(false)]out ISelection newSelection)
            where T : ITrack
        {
