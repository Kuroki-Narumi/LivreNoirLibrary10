...
{
    public sealed class SmpteOffsetEvent(int hour, int minute, int second, int frame, int subframe) : IMetaObject, IObject<SmpteOffsetEvent>
    {
        ...
        public SmpteOffsetEvent(Events.SmpteOffset source) : this(source.Hour, source.Minute, source.Second, source.Frame, source.Subframe) { }
        ...
        {
            timeline.Add(tick, new Events.SmpteOffset(_hour, _minute, _second, _frame, _sub_frame));
        }
