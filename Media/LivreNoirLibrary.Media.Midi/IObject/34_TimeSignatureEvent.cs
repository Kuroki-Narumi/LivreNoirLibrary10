...
{
    public sealed class TimeSignatureEvent(TimeSignature value) : SingleValueEvent<TimeSignature>(value), IMetaObject, IObject<TimeSignatureEvent>
    {
        ...
        {
            timeline.Add(tick, new Events.TimeSignature(_value));
        }
