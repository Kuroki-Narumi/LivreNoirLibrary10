...
{
    public sealed class SysEx(StatusType type, byte[] data) : DataObjectBase(ObjectType.SysEx, data), IObject, IObject<SysEx>
    {
        ...
        public SysEx(Events.SysEx source) : this(source.Status, source.Data) { }
        ...
        {
            timeline.Add(tick, new Events.SysEx(_type is StatusType.SysEx1, _data));
        }
