...
{
    public sealed class Note : INote, IObject<Note>
    {
        private byte _nn;
        private byte _vel;
        ...
        public int Number { get => _nn; set => _nn = Events.Event.GetMax127(value); }
        public int Velocity { get => _vel; set => _vel = Events.Event.GetMax127(value); }
        ...
        {
            Events.NoteOn on = new(channel, _nn, _vel);
            Events.NoteOff off = new(channel, _nn);
