...
{
    public sealed class MetaText(MetaType type, string text) : IMetaObject, IObject<MetaText>
    {
        ...
        public MetaText(Events.MetaText source) : this(source.Type, source.Text) { }
        ...
        {
            timeline.Add(tick, new Events.MetaText(_type, _text));
        }
