...
namespace LivreNoirLibrary.Media
{
    ...
    public class WaveBufferPlayer : AudioPlayerBase
    {
        ...
        private void SetPosition(long position) => SetValue(ref _position, position, nameof(Position));
            ...
            set
            {
                ...
                if (_start != value)
                {
                    ProcessPropertyChange(() =>
                    {
                        if (value > _end)
                        {
                            SetValue(ref _start, _end, nameof(RangeStart));
                            SetValue(ref _end, value, nameof(RangeEnd));
                        }
                        else
                        {
                            SetValue(ref _start, value, nameof(RangeStart));
                        }
                    });
                }
            }
            ...
            set
            {
                ...
                if (_end != value)
                {
                    ProcessPropertyChange(() =>
                    {
                        if (value < _start)
                        {
                            SetValue(ref _end, _start, nameof(RangeEnd));
                            SetValue(ref _start, value, nameof(RangeStart));
                        }
                        else
                        {
        ...
        public bool IsLoop
        {
            ...
            set
            {
                if (_is_loop != value)
                {
                    ProcessPropertyChange(() => SetValue(ref _is_loop, value, nameof(IsLoop)));
                }
            }
        }
        ...
        public void SetRange(long start, long end, bool? loop = null)
        {
            ...
            SetValue(ref _start, start, nameof(RangeStart));
            SetValue(ref _end, end, nameof(RangeEnd));
            SetValue(ref _is_loop, loop ?? _is_loop, nameof(IsLoop));
            if (playing)
            {
                ProcessPlay();
            }
