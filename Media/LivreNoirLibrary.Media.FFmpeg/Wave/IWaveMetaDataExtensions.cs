...
namespace LivreNoirLibrary.Media.Wave
{
    ...
    {
        extension(IWaveMetaData obj)
        {
            public double Tempo { get => obj.GetTempo(); set => obj.SetTempo(value); }
            public string? Genre { get => obj.GetInfoText(ChunkIds.IGenre); set => obj.SetInfoText(ChunkIds.IGenre, value); }
            public string? Title { get => obj.GetInfoText(ChunkIds.IName); set => obj.SetInfoText(ChunkIds.IName, value); }
            public string? Artist { get => obj.GetInfoText(ChunkIds.IArtist); set => obj.SetInfoText(ChunkIds.IArtist, value); }
            public string? Copyright { get => obj.GetInfoText(ChunkIds.ICopyright); set => obj.SetInfoText(ChunkIds.ICopyright, value); }
            public string? Comment { get => obj.GetInfoText(ChunkIds.IComment); set => obj.SetInfoText(ChunkIds.IComment, value); }
            public string? Software { get => obj.GetInfoText(ChunkIds.ISoft); set => obj.SetInfoText(ChunkIds.ISoft, value); }
        }
        ...
        public static double GetTempo(this IWaveMetaData meta) => TryGetChunk<Acid>(meta, out var chunk) ? chunk.Tempo : IWaveMetaData.DefaultTempo;
