...
{
    internal interface IAudioBufferDecoder : IAudioBufferInternal
    {
        /// <summary>
        ...
        /// <returns><see langword="true"/> if the setup succeeded, otherwise <see langword="false"/>.</returns>
        ...
        /// </summary>
        /// <returns>
        /// <see langword="false"/> if successed to read. <see langword="true"/> if the stream has reached its end. 
        /// </returns>
        bool UpdateBuffer();
    }
}
