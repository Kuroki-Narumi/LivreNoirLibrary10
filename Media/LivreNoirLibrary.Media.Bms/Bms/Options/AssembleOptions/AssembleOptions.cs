...
{
    public partial class AssembleOptions : ObservableObjectBase, IAssembleCoreOptions, IFlowOptions, IAssemblePreviewOptions, IAdjustOptions, IConvertTargetOptions, IAssembleReplaceOptions
    {
        ...
        public bool AdjustBeginning { get; set => SetValue(ref field, value); } = true;
        ...
        public double ReplaceMargin { get; set => SetValue(ref field, value); }
        ...
        public bool PlaysLongEnd { get; set => SetValue(ref field, value); }
        public bool Overlap { get; set => SetValue(ref field, value); }
        public bool SetMarker { get; set => SetValue(ref field, value); } = true;

        public SampleFormat SampleFormat { get; set => SetValue(ref field, value); }
        public bool OpenWave { get; set => SetValue(ref field, value); }

        [JsonIgnore]
        public string RootDirectory { get; set => SetValue(ref field, value); } = "";
        [JsonIgnore]
        public double Offset { get; set => SetValue(ref field, value); }
        [JsonIgnore]
        ...
        public void EnsureMode(bool isSelectionEnabled)
        {
            ...
            ConvertTarget.IsSelectionEnabled = isSelectionEnabled;
        }
