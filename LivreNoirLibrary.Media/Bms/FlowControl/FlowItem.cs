...
{
    public abstract class FlowItem : ObjectBase
    {
        public abstract string DumpHeader { get; }
        public abstract string DumpChid { get; }

        internal void Dump(BmsTextWriter writer, BmsData root)
        {
            writer.Dump(Note);
        ...
        internal virtual void Dump_Content(BmsTextWriter writer, BmsData root) { }
        internal virtual void Dump_Footer(BmsTextWriter writer, BmsData root) { }
