...
{
    public class RawData : SortedList<int, Bar>
    {
        ...
        public void Set(int barNumber, Channel channel, string list, int radix, int? replace = null)
        {
            GetBar(barNumber).Set(channel, list, radix, replace);
        }

        public void Set(int barNumber, ChannelData data, int? replace = null)
        {
        ...
        public void Merge(RawData other)
        {
