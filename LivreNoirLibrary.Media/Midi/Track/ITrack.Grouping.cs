...
namespace LivreNoirLibrary.Media.Midi
{
    ...
    {
        public static bool Dechord<T>(this T track, out Selection newSelection)
            where T : ITrack
        {
            newSelection = [];
        ...
        public static bool Dechord<T>(this T track, Selection selection, out Selection newSelection)
            where T : ITrack
        {
            newSelection = [];
            var timeline = track.Timeline;
        ...
        public static bool Enchord<T>(this T track, GroupingOptions options, out Selection newSelection)
            where T : ITrack
        {
            Selection selection = [];
        ...
        public static bool Enchord<T>(this T track, Selection selection, GroupingOptions options, out Selection newSelection)
            where T : ITrack
        {
            var flag = false;
        ...
        public static bool EnchordAll<T>(this T track, Selection selection, out Selection newSelection, bool markEachNote = true)
            where T : ITrack
        {
        ...
        public static bool Enchord_Glide<T>(this T track, Selection selection, out Selection newSelection)
            where T : ITrack
        {
            if (selection.Count is <= 1)
            {
        ...
        public static bool Enchord_Group<T>(this T track, Selection selection, int n, bool downward, out Selection newSelection)
            where T : ITrack
            => Enchord_General(track, selection, downward, list => list.EachGroup(n), out newSelection);
        public static bool Enchord_Tuple<T>(this T track, Selection selection, int n, bool downward, out Selection newSelection)
            where T : ITrack
        ...
        private static bool Enchord_General<T>(T track, Selection selection, bool downward, ListEnum func, out Selection newSelection)
            where T : ITrack
        {
        ...
        private static bool AddChord<T>(T track, List<Note> list, Rational pos, ListEnum func, Selection newSelection)
            where T : ITrack
        {
        ...
        public static bool AutoGroup<T>(this T track, Selection selection)
            where T : ITrack
        {
