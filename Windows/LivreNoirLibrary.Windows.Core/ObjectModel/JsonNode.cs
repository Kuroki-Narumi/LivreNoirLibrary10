...
namespace LivreNoirLibrary.ObjectModel
{
    ...
    {
        public object? Value { get; set => SetValue(ref field, value, [nameof(ValueText)]); }
    ...
    public class JsonCollectionNode : JsonNode, IClear
    {
        ...
        public override string ValueText => $"<Collection count: {Children.Count}>";
    ...
    {
        public override string ValueText => Value is true ? "true" : "false";
    ...
    {
        public override string ValueText => IsExpanded ? "" : $"[ {Children.Count} ]";
    ...
    {
        public override string ValueText => IsExpanded ? "" : "{ ... }";
