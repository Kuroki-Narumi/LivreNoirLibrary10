...
namespace LivreNoirLibrary.Windows
{
    ...
    public class VocabData : ObservableObjectBase, IJsonWriter, IEquatable<VocabData>
    {
        public const string Leader = "...";

        public string Value { get; set => SetValue(ref field, value, [nameof(WithLeader), nameof(MenuHeader), nameof(MenuHeaderWithLeader)]); } = "";
        ...
        public void Update(VocabData source)
        {
            ...
            if (!string.IsNullOrEmpty(source.KeyTip))
            {
                KeyTip = source.KeyTip;
            }
        }

        public bool Equals(VocabData? other) => other is not null && Value == other.Value && KeyTip == other.KeyTip;
