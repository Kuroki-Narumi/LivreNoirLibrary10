...
namespace LivreNoirLibrary.Windows
{
    public static partial class WindowsExtensions
    {
        ...
        public static IEnumerable<string> EnumAvailable(this DragEventArgs e, Regex acceptExt) => GetFileList(e).EnumerateMatched(acceptExt);
        public static IEnumerable<string> EnumAvailable(this DragEventArgs e, params Regex[] acceptExts) => GetFileList(e).EnumerateMatched(acceptExts);
