...
namespace LivreNoirLibrary.Windows.Controls
{
    public class SelectionRect : ISelectionRect
    {
        ...
        public ElementSelectionMode Mode
        {
            get => _mode;
            set
            {
                ...
                Fill = value switch
                {
                    ElementSelectionMode.New => GetBrush(SelectionColors.Fill),
                    ElementSelectionMode.Union => GetBrush(SelectionColors.Union),
                    ElementSelectionMode.Except => GetBrush(SelectionColors.Except),
                    ElementSelectionMode.Intersect => GetBrush(SelectionColors.Intersect),
                    _ => null
                };
            }
        }
